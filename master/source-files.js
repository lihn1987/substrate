...
sourcesIndex["io_lifetimes"] = {"name":"","files":["impls_std.rs","impls_std_views.rs","lib.rs","portability.rs","raw.rs","traits.rs","types.rs","views.rs"]};
...
sourcesIndex["libp2p_swarm"] = {"name":"","dirs":[{"name":"behaviour","files":["either.rs","toggle.rs"]},{"name":"connection","dirs":[{"name":"pool","files":["concurrent_dial.rs","task.rs"]}],"files":["error.rs","handler_wrapper.rs","pool.rs","substream.rs"]},{"name":"handler","files":["dummy.rs","either.rs","map_in.rs","map_out.rs","multi.rs","one_shot.rs","select.rs"]}],"files":["behaviour.rs","connection.rs","dial_opts.rs","handler.rs","lib.rs","registry.rs","upgrade.rs"]};
...
sourcesIndex["rustix"] = {"name":"","dirs":[{"name":"ffi","files":["mod.rs"]},{"name":"fs","files":["abs.rs","at.rs","constants.rs","copy_file_range.rs","cwd.rs","dir.rs","fadvise.rs","fcntl.rs","fd.rs","file_type.rs","makedev.rs","memfd_create.rs","mod.rs","openat2.rs","sendfile.rs","statx.rs"]},{"name":"imp","dirs":[{"name":"linux_raw","dirs":[{"name":"arch","dirs":[{"name":"inline","files":["mod.rs","x86_64.rs"]}],"files":["mod.rs"]},{"name":"fs","files":["dir.rs","makedev.rs","mod.rs","syscalls.rs","types.rs"]},{"name":"io","files":["epoll.rs","errno.rs","mod.rs","poll_fd.rs","syscalls.rs","types.rs"]},{"name":"mm","files":["mod.rs","syscalls.rs","types.rs"]},{"name":"param","files":["auxv.rs","mod.rs"]},{"name":"process","files":["cpu_set.rs","mod.rs","syscalls.rs","types.rs","wait.rs"]},{"name":"time","files":["mod.rs","types.rs"]}],"files":["c.rs","conv.rs","elf.rs","mod.rs","reg.rs"]}]},{"name":"io","files":["close.rs","dup.rs","errno.rs","eventfd.rs","ioctl.rs","mod.rs","owned_fd.rs","pipe.rs","poll.rs","read_write.rs","stdio.rs"]},{"name":"mm","files":["madvise.rs","mmap.rs","mod.rs","msync.rs","userfaultfd.rs"]},{"name":"param","files":["auxv.rs","mod.rs"]},{"name":"path","files":["arg.rs","mod.rs"]},{"name":"process","files":["chdir.rs","exit.rs","id.rs","kill.rs","membarrier.rs","mod.rs","priority.rs","rlimit.rs","sched.rs","sched_yield.rs","uname.rs","wait.rs"]}],"files":["const_assert.rs","cstr.rs","lib.rs","utils.rs"]};
...
sourcesIndex["sc_network_common"] = {"name":"","dirs":[{"name":"sync","files":["message.rs","metrics.rs","warp.rs"]}],"files":["config.rs","lib.rs","message.rs","request_responses.rs","sync.rs"]};
...
sourcesIndex["wasmtime_jit"] = {"name":"","dirs":[{"name":"profiling","files":["jitdump_linux.rs","vtune_disabled.rs"]},{"name":"unwind","files":["systemv.rs"]}],"files":["code_memory.rs","debug.rs","demangling.rs","instantiate.rs","lib.rs","profiling.rs","unwind.rs"]};
